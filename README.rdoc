...
=== ToDo
  * Move test suit to MiniTestSpec
  * Remove commented out code pieces
  * Make comments obsolete and remove them
  * Decouple tests for resources form oauth implementation
  * Make Netflix::Queue.add test that the position paramter is being used
  * Add support for more resources
  * Add support for more attributes on existing resources
